...
import org.pojo.dto.ParallelGatwayDTO;
import org.pojo.dto.UserTaskModelDTO;
import org.pojo.entity.BpmProcessBaseEty;
import org.pojo.entity.BpmTaskEntity;
import org.pojo.entity.BpmTaskModelEntity;
import org.pojo.enums.GatewayJumpTypeEnum;
import org.pojo.exception.BpmBusinessException;
import org.pojo.form.BpmJumpForm;
import org.pojo.query.BpmTaskModelQuery;
import org.pojo.query.BpmTaskQuery;
import org.service.BpmProcessService;
import org.service.BpmUserTaskService;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;
import org.springframework.util.CollectionUtils;
import org.util.UserTaskAttrUtil;
...
public class FlowableBpmUserTaskServiceImpl implements BpmUserTaskService {
    ...
    private static FlowableBpmUserTaskServiceImpl flowableBpmUserTaskService;
    ...
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
    @Override
    public void jump(BpmJumpForm form,ProcessEngine processEngine) {
        this.runtimeService = processEngine.getRuntimeService();
        FlowableBpmProcessServiceImpl flowableBpmProcessService = new FlowableBpmProcessServiceImpl();
        this.bpmProcessService = flowableBpmProcessService;
        ...
        UserTaskModelDTO userTaskModelsDTO = bpmProcessService.getUserTaskModelDto(query,processEngine);
    ...
    protected void setCurrentTaskDueDate(String tenantId, String processInstanceTaskId) throws Exception {
    ...
    @PostConstruct
    public void init() {
        flowableBpmUserTaskService = this;
        flowableBpmUserTaskService.taskService = this.taskService;
    }
}
